            ...
            <div className="md:col-span-3 flex items-end justify-between gap-2.5 h-48 px-2 border-b border-zinc-100 dark:border-zinc-800 pb-1">
              {weeklyData.map((bar) => (
                <div key={bar.day} className="flex flex-col items-center justify-end h-full flex-1 group">
                  ...
                  >
                    {/* Tooltip on hover */}
                    <span className="absolute bottom-full mb-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200 bg-zinc-900 text-white text-[10px] font-semibold px-2 py-1 rounded-md pointer-events-none shadow-sm dark:bg-white dark:text-black whitespace-nowrap z-10">
                      {bar.value}k ops
                    </span>
                    <div 
