...
import { AuditLogEntity, AuditLogAction } from "@/modules/audit-logs/domain/entities/audit-log.entity";
...
export class DrizzleAuditLogRepository implements IAuditLogRepository {
  async create(log: Omit<AuditLogEntity, "id" | "createdAt">): Promise<AuditLogEntity> {
